...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        if let remoteNotif = launchOptions?[.remoteNotification] as? [AnyHashable : Any] {
            PushHelper.shared.lastPush = PushNotification(pushData: remoteNotif)
        }
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable : Any], fetchCompletionHandler completionHandler: @escaping (UIBackgroundFetchResult) -> Void) {
          ...
          PushHelper.shared.lastPush = PushNotification(pushData: userInfo)
...
extension AppDelegate: UNUserNotificationCenterDelegate {
    ...
    public func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Swift.Void) {
        ...
        case GluuConstants.NotificationActionApprove:
            PushHelper.shared.lastPush = PushNotification(pushData: userInfo, action: .approve)
            
        case GluuConstants.NotificationActionDeny:
            PushHelper.shared.lastPush = PushNotification(pushData: userInfo, action: .decline)
