...
-(void)enroll:(NSDictionary*)parameters baseUrl:(NSString*)baseUrl isDecline:(BOOL)isDecline isSecureClick:(BOOL)isSecureClick callBack:(TokenResponseCompletionHandler)handler {
    ...
    [_u2FKey handleEnrollmentRequest:[[EnrollmentRequest alloc] initWithVersion:version challenge:challenge application:appParam issuer:baseUrl] isDecline:isDecline isSecureClick: isSecureClick callback:^(EnrollmentResponse *response, NSError *error){
